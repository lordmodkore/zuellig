...
class SageCustomWalkers extends Walker_Nav_Menu
{
    ...
    function start_el(&$output, $item, $depth = 0, $args = null, $id = 0)
    {
        ...
        $output .= '<li id="menu-item-' . esc_attr($item->ID) . '" class="nav-item' . esc_attr(implode(' ', $item->classes)) . '">';
...
//        }
        ...
        $output .= '<a href="' . esc_url($item->url) . '" itemprop="url" class="sf-with-ul nav-link"><span itemprop="name">' . esc_html($item->title) . '</span></a>';
    }
