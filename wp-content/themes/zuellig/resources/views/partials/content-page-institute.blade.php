...
<section class="default_section-padding">
    <div class="container">
        ...
        @if(have_rows('initiatives'))
            ...
            <div class="row">
                <div class="col-4"></div>
                <div class="col-lg-8 col-md-8 col-sm-12 mb-3 border_inner-color py-3">
                    <div class="row">
                        <div class="col-1"></div>
                        <div class="col-lg-10">
                            <div>
...
<section class="default_section-padding section_goals-bg">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="fw-bold heading_content-text text-center">{!! get_field('featured_content_area') !!}</h1>
